...
int distance1, previous_distance1, percentage1, distance2, previous_distance2, percentage2, distance3=0, distance4=0;

char numberString1[4], numberString2[4];

int distances[2] = {0,0};	//stores the distances in an array
